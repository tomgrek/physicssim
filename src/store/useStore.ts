...
export interface PhysicsState {
  ...
  loadPreset: (name: 'pendulum' | 'cubes' | 'gears' | 'machine' | 'rack_pinion' | 'inclined_plane' | 'pulley_system' | 'cartpole' | 'newtons_cradle' | 'suspension_bridge' | 'paper_plane' | 'monkey_head' | 'golden_gate' | 'golden_gate_mesh') => void;
